...
ROI_TOP = 0.1  # Top 10% of the frame height
ROI_BOTTOM = 0.9  # Bottom 90% of the frame height
ROI_LEFT = 0.1  # Left 10% of the frame width
ROI_RIGHT = 0.9  # Right 90% of the frame width
        ...
        if process.multi_hand_landmarks:
            for hand_landmarks, handedness in zip(
                ...
                match mode:
                    ...
                    case "GAMING":
                        handle_gaming_mode(
                            hand_landmarks, handedness, frame 
                        )
    cap.release()
